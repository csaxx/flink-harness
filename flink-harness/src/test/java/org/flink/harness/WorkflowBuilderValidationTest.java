...
class WorkflowBuilderValidationTest {
    ...
    void duplicateIdRejected() {
        WorkflowBuilder b = new WorkflowBuilder(Mode.CONTINUOUS, false);
    ...
    void unresolvedGenericsFailAtBuildAndOptOutPasses() {
        WorkflowBuilder strict = new WorkflowBuilder(Mode.CONTINUOUS, false);
        ...
        WorkflowBuilder lax = new WorkflowBuilder(Mode.CONTINUOUS, false);
