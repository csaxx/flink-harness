...
class ProcessFunctionHarnessTest {
    ...
    void metricsSnapshotUpdateAfterInvocation() {
        ...
        harness.processElement("x", null);
        harness.processElement("y", null);
