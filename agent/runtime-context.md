...
| `StandaloneRuntimeContext(String, Map<String,String>, StandaloneOperatorMetricGroup)` | The harness wiring: the metric group is injected from the owning `AbstractRichFunctionHarness` (only rich functions get a context and thus a metric group). |
